...
const Seo = ({
  ...
  useEffect(() => {
    ...
    [
      ...
      { attribute: "name", key: "author", content: siteConfig.name },
      { attribute: "name", key: "application-name", content: siteConfig.name },
      { attribute: "name", key: "apple-mobile-web-app-title", content: siteConfig.name },
      ...
      { attribute: "property", key: "og:site_name", content: siteConfig.name },
      ...
      { attribute: "property", key: "og:image:alt", content: `${title} - ${siteConfig.name}` },
